...
#define TICKS_PER_REV_TURRET  1024.0 * (220.0/24.0)  // actual measured 1024.0 * 3.0 * (220/24) (changed by CRI project- 1024 the new encoder, 220/24 being the other gear)
