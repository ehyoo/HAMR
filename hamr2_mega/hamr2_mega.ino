...
//      h_rdot_cmd = desired_h_rdot;
      ...
      set_speed(&pid_vars_M1,
                ...
                M1_DIR_PIN, 
                M1_PWM_PIN);
//      Serial.println(M1_DIR_PIN);
//      Serial.println(M1_PWM_PIN);
...
//      Serial.println(M2_DIR_PIN);
//      Serial.println(M2_PWM_PIN);
//      Serial.println(desired_M2_v);
...
//  digitalWrite(MT_DIR_PIN, MT_FORWARD); // HIGH is CLOCKWISE (use low for default)
