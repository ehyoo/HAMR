...
void loop() {
  ...
  if((millis()-lastMilli) >= LOOPTIME) {
    ...
    if (millis() - startMilli >= 0) {
      ...
      set_speed(-255 * speed_req_ddrive, PIN_M1_DRIVER_INA, PIN_M1_DRIVER_INB, PIN_M1_DRIVER_PWM);
      set_speed(-255 * speed_req_ddrive, PIN_M2_DRIVER_INA, PIN_M2_DRIVER_INB, PIN_M2_DRIVER_PWM);
