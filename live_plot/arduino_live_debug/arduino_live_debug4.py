...
# SLIDERS
slider_r_motor = MySlider(plt.axes([0.06, 0.9, 0.2, 0.03]), 'DD Setpoint', MIN_R_MOTOR, MAX_R_MOTOR, valinit=0, valfmt='%1.1f', dragging = False)
...
slider_t_motor = MySlider(plt.axes([0.06, 0.8, 0.2, 0.03]), 'T Setpoint', MIN_T_MOTOR, MAX_T_MOTOR, valinit=0, valfmt='%1.1f', dragging = False)
...
slider_D = MySlider(plt.axes([0.06, 0.6, 0.2, 0.03]), 'Derivative', MIN_D, MAX_D, valinit=0, valfmt='%1.3f', dragging = False)
