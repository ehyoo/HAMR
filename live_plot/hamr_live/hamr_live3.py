...
# BUTTONS
button_connect = MyButton(plt.axes([0.01, 0.01, 0.05, 0.075]), 'Connect', color='#FFFFFF')
button_connect.on_clicked(callback_connect) 

button_log_data = MyButton(plt.axes([0.1, 0.01, 0.08, 0.075]), 'Log Data', color='#FFFFFF')
button_log_data.on_clicked(callback_log_data)

button_pause_graph = MyButton(plt.axes([0.2, 0.01, 0.08, 0.075]), 'Pause Graph', color='#FFFFFF')
button_pause_graph.on_clicked(callback_pause_graph)

button_update_arduino = MyButton(plt.axes([0.35, 0.01, 0.1, 0.075]), 'Update Arduino', color='#FFFFFF')
button_update_arduino.on_clicked(callback_update_arduino)

button_reset_arduino = MyButton(plt.axes([0.47, 0.01, 0.1, 0.075]), 'Reset Arduino', color='#FFFFFF')
button_reset_arduino.on_clicked(callback_reset_arduino)

# SLIDERS
slider_drag = True

INPUT_SLIDER_WIDTH = .2
slider_input_1 = MySlider(plt.axes([0.06, .22, INPUT_SLIDER_WIDTH, 0.03]), 'X dot', MIN_R_MOTOR, MAX_R_MOTOR, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_input_1.on_changed(callback_slider_input_1)

slider_input_2 = MySlider(plt.axes([0.06, .17, INPUT_SLIDER_WIDTH, 0.03]), 'Y dot', MIN_L_MOTOR, MAX_L_MOTOR, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_input_2.on_changed(callback_slider_input_2)

slider_input_3 = MySlider(plt.axes([0.06, .12, INPUT_SLIDER_WIDTH, 0.03]), 'Theta dot', MIN_T_MOTOR, MAX_T_MOTOR, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_input_3.on_changed(callback_slider_input_3)


PID_SLIDER_WIDTH = .18
slider_P1 = MySlider(plt.axes([0.34, 0.22, PID_SLIDER_WIDTH, 0.03]), 'P', MIN_P, MAX_P, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_P1.on_changed(callback_slider_P)

slider_I1 = MySlider(plt.axes([0.56, 0.22, PID_SLIDER_WIDTH, 0.03]), 'I', MIN_I, MAX_I, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_I1.on_changed(callback_slider_I)

slider_D1 = MySlider(plt.axes([0.78, 0.22, PID_SLIDER_WIDTH, 0.03]), 'D', MIN_D, MAX_D, valinit=0, valfmt='%1.3f', dragging = slider_drag)
slider_D1.on_changed(callback_slider_D)


slider_P2 = MySlider(plt.axes([0.34, 0.17, PID_SLIDER_WIDTH, 0.03]), 'P', MIN_P, MAX_P, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_P2.on_changed(callback_slider_P)

slider_I2 = MySlider(plt.axes([0.56, 0.17, PID_SLIDER_WIDTH, 0.03]), 'I', MIN_I, MAX_I, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_I2.on_changed(callback_slider_I)

slider_D2 = MySlider(plt.axes([0.78, 0.17, PID_SLIDER_WIDTH, 0.03]), 'D', MIN_D, MAX_D, valinit=0, valfmt='%1.3f', dragging = slider_drag)
slider_D2.on_changed(callback_slider_D)


slider_P3 = MySlider(plt.axes([0.34, 0.12, PID_SLIDER_WIDTH, 0.03]), 'P', MIN_P, MAX_P, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_P3.on_changed(callback_slider_P)

slider_I3 = MySlider(plt.axes([0.56, 0.12, PID_SLIDER_WIDTH, 0.03]), 'I', MIN_I, MAX_I, valinit=0, valfmt='%1.2f', dragging = slider_drag)
slider_I3.on_changed(callback_slider_I)

slider_D3 = MySlider(plt.axes([0.78, 0.12, PID_SLIDER_WIDTH, 0.03]), 'D', MIN_D, MAX_D, valinit=0, valfmt='%1.3f', dragging = slider_drag)
slider_D3.on_changed(callback_slider_D)

#RADIO BUTTON
radio_mode = RadioButtons(plt.axes([0.6, 0.01, 0.06, 0.1]), ('Holonomic', 'Motor', 'Differential'))
radio_mode.on_clicked(callback_radio_mode)

# CHECKBOX
check = MyCheckBox(plt.axes([0.7, 0.01, 0.1, 0.1]), ['Immediate\n Update'], [False])
